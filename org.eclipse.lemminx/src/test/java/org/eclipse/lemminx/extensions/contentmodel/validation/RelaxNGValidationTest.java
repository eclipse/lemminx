...
public class RelaxNGValidationTest {
	...
	@Test
	public void relaxNGWithBrokenSchema() throws Exception {
		String xml = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?> \r\n" + //
				"<?xml-model href=\"src/test/resources/rng/broken.rng\"?>\r\n" + //
				"<root><item /></root>";
		testDiagnosticsFor(xml, d(1, 17, 52, RelaxNGErrorCode.InvalidRelaxNG));
	}
	...
	public void relaxNGWithMissingAttributeValue() throws Exception {
		String xml = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?> \r\n" + //
				...
				"<dress size=\"\"></dress>";
		testDiagnosticsFor(xml, d(2, 7, 11, RelaxNGErrorCode.BadAttribute),
				d(2, 23, 23, RelaxNGErrorCode.IncompleteContentModel));
	}
	...
	public void relaxNGWithBadAttributeValue() throws Exception {
		...
		testDiagnosticsFor(xml, d(2, 7, 11, RelaxNGErrorCode.BadAttribute),
				d(2, 31, 31, RelaxNGErrorCode.IncompleteContentModel));
	}
	...
	public void relaxNGWithUndefinedAttribute() throws Exception {
		...
		testDiagnosticsFor(xml, d(2, 20, 24, RelaxNGErrorCode.BadAttribute),
				d(2, 36, 36, RelaxNGErrorCode.IncompleteContentModel));
	}
	...
	public void relaxNGWithUndefinedElement() throws Exception {
		...
		testDiagnosticsFor(xml, d(2, 21,25, RelaxNGErrorCode.BadTagName));
	}
	...
	public void relaxNGWithInvalidElementContent() throws Exception {
		...
		testDiagnosticsFor(xml, d(2, 20,24, RelaxNGErrorCode.BadText));
	}
	...
	public void relaxNGElementTextContentDoesntMatchType() throws Exception {
		...
		testDiagnosticsFor(xml, d(2, 13,17, RelaxNGErrorCode.BadText),
				d(2, 7, 24, RelaxNGErrorCode.BadText));
	}

...
/**
 * XML legacy formatter services tests
 *
 */
public class XMLFormatterLegacyTest extends AbstractCacheBasedTest {
	...
	private static void assertFormat(String unformatted, String actual) throws BadLocationException {
		SharedSettings settings = new SharedSettings();
		assertFormat(unformatted, actual, settings);
	}

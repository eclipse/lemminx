...
public class XMLExtensionsRegistry implements IComponentProvider {
	...
	private final List<WorkspaceService> workspaceServiceParticipants;
	 ...
	 * @since 0.14.2
	 */
	public Collection<WorkspaceService> getWorkspaceServiceParticipants() {
		initializeIfNeeded();
	 ...
	 * @since 0.14.2
	 */
	public void registerWorkspaceServiceParticipant(WorkspaceService workspaceServiceParticipant) {
		workspaceServiceParticipants.add(workspaceServiceParticipant);
	}

	public void unregisterWorkspaceServiceParticipant(WorkspaceService workspaceServiceParticipant) {

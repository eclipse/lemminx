...
public interface ICompletionParticipant {
	...
	void onTagOpen(ICompletionRequest completionRequest, ICompletionResponse completionResponse,
			CancelChecker cancelChecker) throws Exception;

	void onXMLContent(ICompletionRequest request, ICompletionResponse response, CancelChecker cancelChecker)
			throws Exception;
	 ...
	 *
	 * @param valuePrefix the attribute value before the offset in which completion
	 *                    was invoked
	 ...
	 * response <code>response</code>
	 *
	 * @param valuePrefix the systemId value before the offset in which completion
	 *                    was invoked
	 * @param request     the completion request
	 * @param response    the completion response
	 * @throws Exception
	 ...
	 *
	 * @param participantId the participant id to find the completion item resolver
	 *                      for
	 * @return the completion item resolver that corresponds to the given
	 *         participant id or null otherwise
	 */

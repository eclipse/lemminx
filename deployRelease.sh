...
then
  ...
  curl -T org.eclipse.lemminx/target/org.eclipse.lemminx-p2repo.zip	-u $RELEASES_USERNAME:$RELEASES_PASSWORD -H "X-Bintray-Version:$VERSION" -H "X-Bintray-Explode:1"  $BINTRAY_URL/$TRAVIS_TAG/
else
